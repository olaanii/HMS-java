...
<title>Doctor Login - Healthcare HMS</title>
...
<body>
	<div class="hms-auth-page">
		<div class="hms-auth-brand">
			...
			<h2>Welcome Back</h2>
			<p>Hospital Management System - Doctor Portal</p>
		</div>
		<div class="hms-auth-form">
			<div class="hms-auth-form-inner">
				<h3 class="auth-title">Doctor Login</h3>
				<p class="auth-subtitle">Enter your credentials to access the doctor dashboard</p>
